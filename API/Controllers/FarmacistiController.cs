...
namespace API.Controllers
{
    public class FarmacistiController : BaseApiController
    {
        ...
        public async Task<ActionResult<Farmacisti>> GetFarmacisti(int id)
        {
        ...
        public async Task<IActionResult> EditFarmacisti(int id, Farmacisti farmacisti)
        {
            farmacisti.Id = id;
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteFarmacisti(int id)
        {
